...
public final class SQLiteRunRepository implements RunRepository {
    ...
    @Override
    public long save(PCBFactory.Type t,int qty,Result r) throws Exception{
        insertP.setString(1,t.name());
    ...
    public Result findById(long id) throws Exception{
        ...
        try(ResultSet rs=findP.executeQuery()){
            ...
            return com.example.pcb.view.JsonParser.parse(json); // reuse client-side parser
        }
    }
